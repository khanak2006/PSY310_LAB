...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Khanak\\OneDrive\\Desktop\\Intentional Binding\\Intentional Binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='\nReport the delay between the key press and beep sound (0 - 999) ; Click SUBMIT after entering the value  ',
        font='Arial',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ib_cond.csv'), 
        seed=None, 
    )
